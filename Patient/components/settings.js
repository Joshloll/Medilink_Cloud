/**
 * Settings Component
 * Renders and manages patient settings
 */
      ...
      <div class="flex flex-col sm:flex-row gap-6">
        <div class="flex-shrink-0">
          <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-24 ring-4 ring-white dark:ring-slate-700 shadow-lg cursor-pointer"
               data-alt="Profile picture of ${user?.firstName || 'Patient'}"
        ...
        <div class="flex-1 space-y-4">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <p class="text-slate-900 dark:text-white font-medium">${user?.firstName || '[First Name]'}</p>
            </div>
            <div>
              <label class="text-sm text-slate-500 dark:text-slate-400 font-medium">Last Name</label>
              <p class="text-slate-900 dark:text-white font-medium">${user?.lastName || '[Last Name]'}</p>
            </div>
            <div>
              <label class="text-sm text-slate-500 dark:text-slate-400 font-medium">Date of Birth</label>
              <p class="text-slate-900 dark:text-white font-medium">${user?.dateOfBirth || '[Date of Birth]'}</p>
            </div>
            <div>
              <label class="text-sm text-slate-500 dark:text-slate-400 font-medium">Gender</label>
              <p class="text-slate-900 dark:text-white font-medium">${user?.gender || '[Gender]'}</p>
            </div>
          </div>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label class="text-sm text-slate-500 dark:text-slate-400 font-medium">Email</label>
              <p class="text-slate-900 dark:text-white font-medium">${user?.email || '[Email]'}</p>
            </div>
            <div>
              <label class="text-sm text-slate-500 dark:text-slate-400 font-medium">Phone</label>
              <p class="text-slate-900 dark:text-white font-medium">${user?.phone || '[Phone]'}</p>
            </div>
          </div>
          <div>
            <label class="text-sm text-slate-500 dark:text-slate-400 font-medium">Address</label>
            <p class="text-slate-900 dark:text-white font-medium">${user?.address || '[Address]'}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return `
    <div class="card p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          <div class="flex items-center gap-3">
            <div class="p-2 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-300">
...
function renderPrivacySettings() {
  return `
    <div class="card p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
      <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-bold text-slate-900 dark:text-white">Privacy Settings</h3>
        <button class="text-primary text-sm font-semibold hover:underline transition-all duration-300">
          Manage Privacy
        </button>
      </div>
      <div class="space-y-4">
        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-medium text-slate-900 dark:text-white">Data Privacy</p>
              <p class="text-sm text-slate-500 dark:text-slate-400">Control how your data is used</p>
            </div>
          </div>
          <button class="px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium hover:bg-blue-600 transition-all">
            Manage
        ...
        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-medium text-slate-900 dark:text-white">Sharing Controls</p>
              <p class="text-sm text-slate-500 dark:text-slate-400">Manage data sharing preferences</p>
            </div>
          </div>
          <button class="px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium hover:bg-blue-600 transition-all">
            Manage
        ...
        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-medium text-slate-900 dark:text-white">Data Deletion</p>
              <p class="text-sm text-slate-500 dark:text-slate-400">Manage data retention policy</p>
            </div>
          </div>
          <button class="px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium hover:bg-blue-600 transition-all">
            Manage
...
function renderAccountSettings() {
  return `
    <div class="card p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
      <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-bold text-slate-900 dark:text-white">Account Settings</h3>
        <button class="text-primary text-sm font-semibold hover:underline transition-all duration-300">
          Manage Account
        </button>
      </div>
      <div class="space-y-4">
        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-medium text-slate-900 dark:text-white">Account Type</p>
              <p class="text-sm text-slate-500 dark:text-slate-400">Free Account</p>
            </div>
          </div>
          <button class="px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium hover:bg-blue-600 transition-all">
            Upgrade to Premium
        ...
        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-medium text-slate-900 dark:text-white">Payment Methods</p>
              <p class="text-sm text-slate-500 dark:text-slate-400">Manage payment options</p>
            </div>
          </div>
          <button class="px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium hover:bg-blue-600 transition-all">
            Manage
        ...
        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          <div class="flex items-center gap-3">
            <div class="p-2 rounded-lg bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-300">
              <span class="material-symbols-outlined">logout</span>
            </div>
            <div>
              <p class="font-medium text-slate-900 dark:text-white">Account Deletion</p>
              <p class="text-sm text-slate-500 dark:text-slate-400">Permanently delete account</p>
            </div>
          </div>
          <button class="px-4 py-2 rounded-lg bg-red-600 text-white text-sm font-medium hover:bg-red-700 transition-colors">
            Delete Account
          </button>
        </div>
      </div>
    ...
    <div class="card p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="font-medium text-slate-900 dark:text-white">Free Account</p>
            <p class="text-sm text-slate-500 dark:text-slate-400">Basic features available</p>
          </div>
        </div>
        <div class="flex items-center gap-3">
...
function handleEditProfile() {
  ...
  const updatedProfile = {
    ...
    address: prompt('Address:', user.address)
  };
...
function handlePrivacySettings() {
  ...
  // In a real app, this would open a privacy modal
}
